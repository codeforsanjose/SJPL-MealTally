...
class DataBase {
    constructor () {
        ...
        const dbName = 'mealtally'
        this.meals_db_name = ''
        if (process.env.NODE_ENV === 'production') {
            this.url = MongoDBData['newProductionURL']
        ...
        client.connect(err => {
            ...
            //addDataToCollection(libCollection, all_libraries)
            //addDataToCollection(collection, test_meals)
            //addDataToCollection(sponsorsCollection, sponsors)
            //addDataToCollection(usersCollection, users)
            //client.close();
        });
