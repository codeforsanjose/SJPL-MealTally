...
function createExcelReport(data) {
    ...
    return new Promise((resolve, reject) => {
        if (data) {
            ...
            addDatasheetHeaders(sheetChildren, data[0], 'Summer Food Service Program: SFSP', 'Children')
            addWeeklyInfomation(sheetChildren, youthTotals, data[0], data[data.length - 1])
            ...
            addDatasheetHeaders(sheetAdult, data[0], 'Summer Food Service Program: SFSP', 'Adult')
            addWeeklyInfomation(sheetAdult, adultTotals, data[0], data[data.length - 1])
